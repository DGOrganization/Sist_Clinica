...
import clinica.com.dgo.controlador.exceptions.NonexistentEntityException;
import clinica.com.dgo.controlador.exceptions.RollbackFailureException;
...
public class CategoriaJpaController implements Serializable {
    ...
    public void create(Categoria categorias) throws RollbackFailureException, Exception {
    ...
    public void edit(Categoria categorias) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
